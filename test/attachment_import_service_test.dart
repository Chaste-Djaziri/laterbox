...
void main() {
  ...
  test(
    'imports valid files once and classifies universal attachments',
    () async {
      ...
      expect(
        File(storage.resolveLocalPath(dbAttachments.first.localPath!))
            .existsSync(),
        isTrue,
      );
    },
  ...
  test(
    'accepts a real DOCX structure and rejects a corrupted DOCX container',
    () async {
