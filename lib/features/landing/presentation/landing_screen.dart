        ...
        child: Row(
          children: [
            ...
            if (!compact) ...[
              ...
              _NavLink(label: 'Download', onTap: () => context.go('/download')),
              ...
              builder: (context, constraints) {
                final cards = const [
                  _FeatureCard(
                    ...
                    body: 'Save from the web, your share sheet, or any device without breaking your flow.',
                  ),
                  _FeatureCard(
                    icon: Icons.auto_awesome_outlined,
                    title: 'Enriched automatically',
                    body: 'Clean previews, useful metadata, and summaries arrive without extra work.',
                  ),
                  _FeatureCard(
                    icon: Icons.search_rounded,
                    title: 'Find it fast',
                    body: 'Search and collections make the right thing easy to rediscover at the right time.',
                  ),
                ];
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          body,
          style: const TextStyle(color: _muted, height: 1.55, fontSize: 15),
        ),
      ],
    ),
  );
    ...
    children: [
      ...
      ConstrainedBox(
        ...
        child: Text(
          description,
          textAlign: TextAlign.center,
          style: const TextStyle(color: _muted, fontSize: 17, height: 1.55),
        ),
      ),
    ],
  );
  ...
  Widget build(BuildContext context) {
    ...
    const steps = [
      _Step(
        number: '01',
        title: 'Save it',
        body: 'Send any link, thought, or file to laterbox.',
      ),
      _Step(
        number: '02',
        title: 'We tidy it',
        body: 'The details and preview are organized for you.',
      ),
      _Step(
        number: '03',
        title: 'Come back anytime',
        body: 'Search, browse, and pick up exactly where you left off.',
      ),
    ];
    return Container(
      color: _ink,
  ...
  Widget build(BuildContext context) => Column(
    children: [
      Container(
        ...
        decoration: BoxDecoration(
          color: const Color(0xFF25362D),
          borderRadius: BorderRadius.circular(14),
          border: Border.all(color: const Color(0xFF3E5749)),
        ),
        child: Text(
          number,
          style: const TextStyle(
            color: Color(0xFFA9D2B9),
            fontWeight: FontWeight.w800,
          ),
        ),
      ),
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              width: 760,
              child: Text(
                'The internet is full of things worth keeping. laterbox gives them a quiet, dependable home—without turning organization into another job.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: _ink,
                  fontSize: 27,
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 14),
              const Text(
                'Start saving in seconds. Your future self will thank you.',
                textAlign: TextAlign.center,
                style: TextStyle(color: Color(0xFFD5E9DC), fontSize: 17),
              ),
