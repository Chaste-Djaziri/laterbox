      ...
      Wrap(
        ...
        children: [
          for (final entry in const {
            ReturnPreset.now: 'Now',
            ReturnPreset.laterToday: 'Later today',
            ReturnPreset.tomorrow: 'Tomorrow',
            ReturnPreset.weekend: 'Weekend',
            ...
            onPressed: () async {
              ...
              if (!result.isAfter(DateTime.now())) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Choose a future time, or select Now.'),
                  ),
                );
                return;
              }
