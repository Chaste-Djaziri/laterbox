...
final class ShareCaptureQueue {
    ...
    init(appGroupId: String = "group.pro.micorp.laterbox") {
        ...
        if let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first {
            self.fallbackContainerURL = appSupport.appendingPathComponent("LaterBox", isDirectory: true)
        } else {
            self.fallbackContainerURL = FileManager.default.temporaryDirectory.appendingPathComponent("LaterBox", isDirectory: true)
        }
