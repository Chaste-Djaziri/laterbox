  ...
  return (
    <AppShell>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-8">
        ...
        {/* Account Section */}
        <section className="p-6 sm:p-7 rounded-3xl bg-white border border-zinc-200/80 space-y-4">
          <div className="flex items-center gap-3">
            <User className="w-5 h-5 text-emerald-600" />
            <h2 className="text-base font-extrabold text-zinc-900">Account</h2>
          </div>
          ...
          {user ? (
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2">
              ...
              <button
                onClick={() => signOut()}
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-zinc-100 hover:bg-red-50 text-zinc-700 hover:text-red-600 text-xs font-bold transition-colors w-fit"
              >
        ...
        <section className="p-6 sm:p-7 rounded-3xl bg-white border border-zinc-200/80 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-base font-extrabold text-zinc-900">Cloud Sync & Storage</h2>
            </div>
            <CloudSyncIndicator />
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
            ...
            <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200/60">
              <p className="text-2xl font-black text-zinc-900">{collections.length}</p>
          ...
          <div className="pt-2 flex flex-wrap items-center gap-3">
            <button
              onClick={() => syncNow()}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-zinc-100 hover:bg-zinc-200 text-zinc-800 text-xs font-bold transition-colors"
            >
        ...
        <section className="p-6 sm:p-7 rounded-3xl bg-white border border-zinc-200/80 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-base font-extrabold text-zinc-900">Connected Applications</h2>
          </div>
          ...
          <div className="pt-2">
            <Link
              href="/download"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-zinc-100 hover:bg-zinc-200 text-zinc-800 text-xs font-bold"
            >
