        ...
        <div className="space-y-10 text-sm leading-relaxed text-[#3a3935]">
          ...
          <section className="space-y-3 p-6 sm:p-8 rounded-3xl bg-white border border-[#e4e0d5]">
            ...
            <div className="p-4 rounded-2xl bg-[#e6edb0]/40 border border-[#d0db84] space-y-1">
              ...
              <p className="text-xs text-[#6c6b63]">Android testing: <a href="https://groups.google.com/g/laterbox-testers" target="_blank" rel="noreferrer" className="font-semibold text-[#171711] underline">Join the tester group</a>, then <a href="https://play.google.com/store/apps/details?id=pro.micorp.laterbox" target="_blank" rel="noreferrer" className="font-semibold text-[#171711] underline">download from Google Play</a>.</p>
            </div>
          </section>
        </div>
      </main>
