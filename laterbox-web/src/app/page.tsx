...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 selection:bg-emerald-500 selection:text-white">
      <Header />
      ...
      <section className="relative pt-16 sm:pt-24 pb-20 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center relative z-10">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200/80 dark:border-emerald-800/60 text-emerald-700 dark:text-emerald-300 text-xs font-bold mb-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
            <Sparkles className="w-3.5 h-3.5 text-emerald-500" />
            <span>Universal Save-For-Later Memory</span>
          </div>

          {/* Heading */}
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight text-zinc-900 dark:text-white leading-[1.08] mb-6">
          ...
          {/* Subheading */}
          <p className="max-w-2xl mx-auto text-base sm:text-xl text-zinc-600 dark:text-zinc-400 leading-relaxed mb-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3.5">
            ...
            <Link
              href="/download"
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-800/80 font-bold text-sm sm:text-base shadow-sm transition-all"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full bg-zinc-100 dark:bg-zinc-800/60 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-200/70 dark:hover:bg-zinc-700/60 font-bold text-sm sm:text-base transition-all"
            >
          ...
          <div className="mt-14 sm:mt-20 max-w-4xl mx-auto rounded-3xl bg-white dark:bg-zinc-900/90 border border-zinc-200/80 dark:border-zinc-800 p-3 sm:p-5 shadow-2xl shadow-zinc-900/10">
            {/* Window bar */}
            <div className="flex items-center gap-2 pb-3 mb-3 border-b border-zinc-100 dark:border-zinc-800 px-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
              <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/60 dark:border-zinc-800/60">
                <div className="flex items-center justify-between gap-2 mb-2">
                  ...
                  <span className="px-2 py-0.5 rounded text-[10px] font-bold uppercase bg-red-50 text-red-600 dark:bg-red-950/50">
                    Video
                  </span>
                </div>
                <h4 className="text-sm font-bold text-zinc-900 dark:text-zinc-100 line-clamp-1 mb-1">
              ...
              <div className="p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/60 dark:border-zinc-800/60">
                <div className="flex items-center justify-between gap-2 mb-2">
                  ...
                  <span className="px-2 py-0.5 rounded text-[10px] font-bold uppercase bg-blue-50 text-blue-600 dark:bg-blue-950/50">
                    Article
                  </span>
                </div>
                <h4 className="text-sm font-bold text-zinc-900 dark:text-zinc-100 line-clamp-1 mb-1">
      ...
      <section className="py-12 border-y border-zinc-200/80 dark:border-zinc-800/80 bg-zinc-100/50 dark:bg-zinc-900/30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-sm font-bold text-zinc-900 dark:text-zinc-100">macOS & Windows</span>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-sm font-bold text-zinc-900 dark:text-zinc-100">iOS & Android</span>
              <span className="text-xs text-zinc-400">Mobile Apps</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <Puzzle className="w-7 h-7 text-emerald-600 dark:text-emerald-400" />
              <span className="text-sm font-bold text-zinc-900 dark:text-zinc-100">Chrome & Firefox</span>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-sm font-bold text-zinc-900 dark:text-zinc-100">Web App</span>
      ...
      <section id="features" className="py-24 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="p-7 rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 hover:border-emerald-500/50 hover:shadow-xl dark:hover:shadow-emerald-950/10 transition-all duration-300"
            >
              <div className="w-12 h-12 rounded-2xl bg-zinc-100 dark:bg-zinc-800/80 flex items-center justify-center mb-5">
                {feature.icon}
              </div>
      ...
      <section id="how-it-works" className="py-20 bg-zinc-100/60 dark:bg-zinc-900/40 border-y border-zinc-200/80 dark:border-zinc-800/80">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-zinc-900 dark:text-white mb-16">
            How laterbox works
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            {steps.map((s) => (
              <div
                key={s.step}
                className="p-6 rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 space-y-3"
              >
                <span className="text-3xl font-black text-emerald-600 dark:text-emerald-400 font-mono">
                  {s.step}
                </span>
                <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">{s.title}</h3>
      ...
      {/* Footer */}
      <footer className="border-t border-zinc-200/80 dark:border-zinc-800/80 py-12 text-xs text-zinc-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 relative">
              <Image src="/branding/laterbox-icon.png" alt="" fill className="object-contain" />
            </div>
            <span className="font-bold text-zinc-700 dark:text-zinc-300">laterbox</span>
